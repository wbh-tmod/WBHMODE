...
{
    public class GypsumHeadProjectile : ModProjectile
    {
        private const string ChainTexturePath = "WBHMODE/Content/Projectiles/GypsumHeadProjectileChain"; // The folder path to the flail chain sprite
        private const string ChainTextureExtraPath = "WBHMODE/Content/Projectiles/GypsumHeadProjectileChainExtra";  // This texture and related code is optional and used for a unique effect
        ...
        public override void AI()
        {
			...
			*/
            ...
            if (Main.rand.NextBool(dustRate))
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Sand, 0f, 0f, 150, default(Color), 1.3f);
        }
