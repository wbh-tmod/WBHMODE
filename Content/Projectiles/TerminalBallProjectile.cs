...
{
    public class TerminalBallProjectile : ModProjectile
    {
        ...
        public override void PostAI()
        {
            ...
            {
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Stone); // Makes the projectile emit dust.
            }
        }
    }
}
