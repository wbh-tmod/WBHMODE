...
{
    public class TerminalBall : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.value = Item.buyPrice(gold: 1, silver: 50); // The amount of money that the item is can be bought for.

            Item.shoot = ModContent.ProjectileType<TerminalBallProjectile>(); // Which projectile this item will shoot. We set this to our corresponding projectile.
