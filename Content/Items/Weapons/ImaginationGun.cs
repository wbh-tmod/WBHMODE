...
namespace WBHMODE.Content.Items.Weapons
{
    public class ImaginationGun : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.damage = 0; // Sets the item's damage. Note that projectiles shot by this weapon will use its and the used ammunition's damage added together.
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            {
                Vector2 perturbedSpeed = velocity.RotatedBy(MathHelper.Lerp(-rotation, rotation, (i / 5f + 1.6f) / (numberProjectiles - 1))); // Watch out for dividing by 0 if there is only 1 projectile.
