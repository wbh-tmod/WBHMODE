...
{
    public class FlowingStoneBrickWall: ModItem
    {
        ...
        {
            Item.DefaultToPlaceableWall(ModContent.WallType<Walls.FlowingStoneBrickWall>());
        ...
        public override void AddRecipes()
        {
            ...
            // 工作台 流动石砖1:4流动石墙
            CreateRecipe(4).
                AddIngredient(ModContent.ItemType<FlowingStoneBrick>(), 1).
